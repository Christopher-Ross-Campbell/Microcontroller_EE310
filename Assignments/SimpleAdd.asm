...
; Initialization
;---------------------
#include "C:\Users\HomePC\Desktop\MPLABX\ProjectFirstAssemblyMPLAB\FirstAssemblyMPLAB.X\AssemblyConfig.inc"
#include <xc.inc>
...
;---------------------
	...
	ADDLW	0x00	;check for STATUS N ---> Branch if NEGATIVE
;NEED BYPASS FOR NEGATIVE MEASURED TEMPS	
